...
def custom_reverse(input_list):
    ...
    for index in range(0, count_list):
        input_list[index] = initial_list[back_count]
        back_count -= 1
    # print(input_list)       
...
if __name__ == "__main__":
    ...
    if count_list1 != count_list2:
        ...
        for index in range(0, count_list1):
...
# custom_remove(notes, 'Fa')
# # # print(custom_pop(multiples))
